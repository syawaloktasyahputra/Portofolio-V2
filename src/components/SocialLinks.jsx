...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/oktodev/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@oktodev",
    icon: Instagram,
    url: "https://www.instagram.com/oktodev/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@oktodev",
    icon: Youtube,
    url: "https://www.youtube.com/@okttodev",
    color: "#FF0000",
  ...
  },
  {
    ...
    subText: "@oktodev",
    icon: Github,
    url: "https://github.com/syawaloktasyahputra",
    color: "#ffffff",
